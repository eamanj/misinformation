...
write.csv(df, file="./results/pakistan/debunk/contacts.csv", row.names = FALSE)
...
table(df$pml_tweet, useNA="ifany")
table(df$ppp_tweet, useNA="ifany")
table(df$pti_tweet, useNA="ifany")

prop.table(table(df$pml_tweet, useNA="ifany"))
prop.table(table(df$ppp_tweet, useNA="ifany"))
prop.table(table(df$pti_tweet, useNA="ifany"))
...
table(df$correct_attention_check)
prop.table(table(df$correct_attention_check))
