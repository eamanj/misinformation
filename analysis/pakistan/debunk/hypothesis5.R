...
############################################
# Hypothesis 5: belief change vs. group of tie
...
summary_stats$group_interest02 <- factor(summary_stats$group_interest02,
                                         levels=c('Ingroup-Not at all', 'Outgroup-Not at all',
                                                  'Ingroup-A little', 'Outgroup-A little',
                                                  'Ingroup-A moderate amount', 'Outgroup-A moderate amount',
                                                  'Ingroup-A good amount', 'Outgroup-A good amount',
                                                  'Ingroup-A great deal', 'Outgroup-A great deal'),
...
print_summary_table(polr(QCORR_MIMSHARE ~ group_treatment*QCORR_CRED01, df_test, Hess=TRUE))
print_summary_table(polr(QCORR_MIMSHARE ~ group_treatment*QCORR_CRED01 + QMIM_DISCUSS_NEWS, df_test, Hess=TRUE))
print_summary_table(polr(QCORR_MIMSHARE ~ group_treatment*QCORR_CRED02, df_test, Hess=TRUE))
print_summary_table(polr(QCORR_MIMSHARE ~ group_treatment*QCORR_CRED02 + QMIM_DISCUSS_NEWS, df_test, Hess=TRUE))
print_summary_table(polr(QCORR_MIMSHARE ~ group_treatment*QCORR_CRED03, df_test, Hess=TRUE))
print_summary_table(polr(QCORR_MIMSHARE ~ group_treatment*QCORR_CRED03 + QMIM_DISCUSS_NEWS, df_test, Hess=TRUE))
...
ggsave("./results/pakistan/debunk/tie_group_intention_to_share.png",  width = 10, height = 6)
...
ggsave("./results/pakistan/debunk/inferred_tie_group_numeric_sharing.png",  width = 6, height = 6)
# binary measure
...
ggplot(summary_stats, aes(x=QCORR_MIMSHARE, y=freq, fill=inferred_group_treatment, label=percent_freq)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=20),
        ...
        legend.title = element_text(size=18), 
        legend.text = element_text(size=16))
ggsave("./results/pakistan/debunk/inferred_tie_group_ordinal_sharing.png",  width = 11, height = 7)
...
output_file <- "./results/pakistan/debunk/tie_group_iv_model.html"
