...
ggsave("./results/india/debunk/tie_strength_intention_to_share.png",  width = 10, height = 6)
...
ggplot(df, aes(inferred_tie_treatment, correction_mimshare_numeric, fill = inferred_tie_treatment)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=20),
        ...
        legend.title = element_text(size=18), 
        legend.text = element_text(size=16))
ggsave("./results/india/debunk/inferred_tie_strength_numeric_sharing.png",  width = 6, height = 6)
# binary measure
...
ggplot(summary_stats, aes(x=QCORR_MIMSHARE, y=freq, fill=inferred_tie_treatment, label=percent_freq)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=20),
        ...
        legend.title = element_text(size=18), 
        legend.text = element_text(size=16))
ggsave("./results/india/debunk/inferred_tie_strength_ordinal_sharing.png",  width = 11, height = 7)
# with tie and group
...
ggplot(df, aes(inferred_tie_group_treatment, correction_mimshare_numeric, fill = inferred_tie_group_treatment)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=20),
        ...
        legend.title = element_text(size=18), 
        legend.text = element_text(size=16))
ggsave("./results/india/debunk/inferred_tie_strength_group_numeric_sharing.png",  width = 11, height = 7)
